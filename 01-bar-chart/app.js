...
function ready(movies) {
  ...
  // Scales
  /**
   * Domain and range can be passed directly to scaleLinear as arguments
   * e.g
   * 
  ...
  header.append('tspan').text('Total revenue by gengre in $US');

  header.append('tspan')
    .text('Film w/ budget and revenue figures, 2000 - 2009')
    .attr('x', 0)
    .attr('dy', '1.5em')
